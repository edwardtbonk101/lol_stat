...
Player_split.create({:player_id => 1, :split_id => 2, :kills => 5, :deaths => 2, :assists => 6, :cs 250, :gold => 50000, :summoner_1 => 'ignite', :summoner_2 => 'flash'})
Player_split.create({:player_id => 2, :split_id => 2, :kills => 5, :deaths => 2, :assists => 6, :cs 250, :gold => 50000, :summoner_1 => 'ignite', :summoner_2 => 'flash'})
Player_split.create({:player_id => 3, :split_id => 2, :kills => 5, :deaths => 2, :assists => 6, :cs 250, :gold => 50000, :summoner_1 => 'ignite', :summoner_2 => 'flash'})
Player_split.create({:player_id => 4, :split_id => 2, :kills => 5, :deaths => 2, :assists => 6, :cs 250, :gold => 50000, :summoner_1 => 'ignite', :summoner_2 => 'flash'})
Player_split.create({:player_id => 5, :split_id => 2, :kills => 5, :deaths => 2, :assists => 6, :cs 250, :gold => 50000, :summoner_1 => 'ignite', :summoner_2 => 'flash'})
Player_split.create({:player_id => 6, :split_id => 2, :kills => 5, :deaths => 2, :assists => 6, :cs 250, :gold => 50000, :summoner_1 => 'ignite', :summoner_2 => 'flash'})
Player_split.create({:player_id => 7, :split_id => 2, :kills => 5, :deaths => 2, :assists => 6, :cs 250, :gold => 50000, :summoner_1 => 'ignite', :summoner_2 => 'flash'})
Player_split.create({:player_id => 8, :split_id => 2, :kills => 5, :deaths => 2, :assists => 6, :cs 250, :gold => 50000, :summoner_1 => 'ignite', :summoner_2 => 'flash'})
Player_split.create({:player_id => 9, :split_id => 2, :kills => 5, :deaths => 2, :assists => 6, :cs 250, :gold => 50000, :summoner_1 => 'ignite', :summoner_2 => 'flash'})
Player_split.create({:player_id => 10, :split_id => 2, :kills => 5, :deaths => 2, :assists => 6, :cs 250, :gold => 50000, :summoner_1 => 'ignite', :summoner_2 => 'flash'})
Player_split.create({:player_id => 12, :split_id => 2, :kills => 5, :deaths => 2, :assists => 6, :cs 250, :gold => 50000, :summoner_1 => 'ignite', :summoner_2 => 'flash'})
Player_split.create({:player_id => 13, :split_id => 2, :kills => 5, :deaths => 2, :assists => 6, :cs 250, :gold => 50000, :summoner_1 => 'ignite', :summoner_2 => 'flash'})
Player_split.create({:player_id => 14, :split_id => 2, :kills => 5, :deaths => 2, :assists => 6, :cs 250, :gold => 50000, :summoner_1 => 'ignite', :summoner_2 => 'flash'})
Player_split.create({:player_id => 15, :split_id => 2, :kills => 5, :deaths => 2, :assists => 6, :cs 250, :gold => 50000, :summoner_1 => 'ignite', :summoner_2 => 'flash'})
